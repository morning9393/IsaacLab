...
class MotionLoader:
    ...
    def __init__(self, motion_file: str, device: torch.device) -> None:
        ...
        self.body_rotations = torch.tensor(data["body_rotations"], dtype=torch.float32, device=self.device) # 82, 15, 4
        ...
        self.body_angular_velocities = torch.tensor(
            data["body_angular_velocities"], dtype=torch.float32, device=self.device # 82, 15, 3
        )
        ...
        self.g1_mapping = {"abdomen_x": "waist_yaw_joint", 
                           "right_shoulder_x": "right_shoulder_roll_joint", 
                           "right_shoulder_y": "right_shoulder_pitch_joint", 
                           "right_shoulder_z": "right_shoulder_yaw_joint", 
        ...
        self.g1_mapping_inv = {v: k for k, v in self.g1_mapping.items()}
    ...
    def get_dof_index(self, dof_names: list[str]) -> list[int]:
        ...
        return indexes, selected_robots_dof_indexes
