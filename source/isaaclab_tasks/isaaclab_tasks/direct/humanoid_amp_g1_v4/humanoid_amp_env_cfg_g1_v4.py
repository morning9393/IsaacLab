...
class HumanoidAmpEnvCfg(DirectRLEnvCfg):
    ...
    * random-start: pose and joint states are set by sampling motion at the start (time zero).
    ...
    #     },
    # )
    robot: ArticulationCfg = G1_CFG_29dof_rev.replace(prim_path="/World/envs/env_.*/Robot")
...
class HumanoidAmpWalkEnvCfg(HumanoidAmpEnvCfg):
    motion_file = '/home/pjlab/文档/shunlin/HumanoidCatching-54ac7da59e75716cc22ab644171766438495b159/legged_gym/resources/dataset/g1_data/crawl_train/runner.pt'
