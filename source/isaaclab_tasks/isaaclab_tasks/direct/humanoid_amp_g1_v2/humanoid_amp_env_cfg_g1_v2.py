...
class HumanoidAmpEnvCfg(DirectRLEnvCfg):
    ...
    # reference_body_motion = "torso"
    reference_body = "pelvis"
    reference_body_motion = "pelvis"
    ...
    * random-start: pose and joint states are set by sampling motion at the start (time zero).
    ...
    # scene
    scene: InteractiveSceneCfg = InteractiveSceneCfg(num_envs=40, env_spacing=10.0, replicate_physics=True)

    # robot
    # robot: ArticulationCfg = G1_CFG.replace(prim_path="/World/envs/env_.*/Robot").replace(
    #     actuators={
    ...
    robot: ArticulationCfg = G1_CFG_V2.copy().replace(prim_path="/World/envs/env_.*/Robot")
    # robot.spawn.usd_path="/home/morning/Robust_Loco/IsaacLab/robots/g1_29dof_rev_1_0/g1_29dof_rev_1_0.usd"
